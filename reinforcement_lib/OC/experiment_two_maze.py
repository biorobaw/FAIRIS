...
def run(args, env):
    ...
    max_lengths = []
    swap_maze = False#args["switch"]
    second_maze = args["second_maze"]
...
#                pickle.dump(comb_dict, fp)
        ...
        if (lowest_run < 50) and (short_time > 20):
            if swap_maze:
                ...
                lowest_run = horizon
                swap_maze = True
                maze_file_2 = f"/home/b/brendon45/oc_tests/mazes/{second_maze}.xml"
                env.set_maze(maze_file_2)
    ...
    save_path = "/home/b/brendon45/oc_tests/data/model.pth"
    torch.save(option_critic.state_dict(), save_path)
...
if __name__== "__main__":
    args = { # 250000
        ...
        "epsilon_start": 1.0, "epsilon_min": 0.0, "epsilon_decay": 100000,
        "max_history": 10000, "batch_size": 32, "freeze_interval": 200, 
        "update_frequency": 4, "term_reg": 0.01, "entropy_reg": 0.01,
        "num_options": 4, "temp": 1, "max_steps_total": 750000, "seed": 0,
        "maze_name": "fourrooms_blank", "state_size": 1024, "horizon": 1000, "pc_file": "uniform_32_l",
        "noise": False, "noise_std": 0.0, "noise_mean": 0.0,
        "switch": True, "second_maze": "fourrooms",
    }
    print(f"Args: {args}")
    ...
    experiment_name = f"{args['maze_name']}_two_standard_experiment"
