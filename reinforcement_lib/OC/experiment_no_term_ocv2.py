...
from option_critic_no_termv2 import OptionCriticFeatures
from option_critic_no_termv2 import critic_loss as critic_loss_fn
from option_critic_no_termv2 import actor_loss as actor_loss_fn
import matplotlib.pyplot as plt
...
#    env.seed(args.seed)
    ...
    while steps < args["max_steps_total"] and not(converged):
        ...
        done = False ; ep_steps = 0 ; curr_op_len = 0
        op_lengths = []
        last_term = 0
        term_time = False
        while not done:
