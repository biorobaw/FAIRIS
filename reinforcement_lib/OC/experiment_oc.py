...
def run(args, env):
    ...
    num_params = sum(p.numel() for p in option_critic.parameters()) * 2
...
if __name__== "__main__":
    args = { # 250000
        ...
        "maze_name": "simple_one_obs", "state_size": 256, "horizon": 1000, "pc_file": "pc_w6_h6",#"uniform_32_l",
    ...
    experiment_name = f"{args['maze_name']}_standard_experiment"
