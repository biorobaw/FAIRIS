...
FAIRIS supports the use of the Husarion's ROSbot. The ROSbot robot is a ROS powered four-wheeled base, used for 
...
FAIRIS provides an easy-to-use Python class that streamlines the process of setting up your simulated 
...
```python
# Changes Working Directory to be at the root of FAIRIS
import os
...
Within FAIRIS, an additional Python class named MyRobot is available. This class is designed to build upon the 
functionalities of the RosBot class, offering further customization for your specific use cases. You can find the 
source code for this class in the file [FAIRIS/Simulation/libraries/RobotLib/MyRobot.py](MyRobot.py).
